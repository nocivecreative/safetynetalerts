 ...
 *
 * <p>Ce service fournit les opérations métier liées aux personnes, incluant :
 * <ul>
...
public class PersonService {
     ...
     *
     * <p>Cette méthode retourne la liste complète des personnes habitant à l'adresse spécifiée.
     *
     * @param address l'adresse à rechercher (doit correspondre exactement)
     * @return la liste des personnes habitant à cette adresse, ou une liste vide si aucune personne n'est trouvée
     */
     ...
     * @return la liste des personnes portant ce nom, ou une liste vide si aucune personne n'est trouvée
     */
     ...
     * @return un ensemble d'adresses email uniques, ou un ensemble vide si aucun résident n'est trouvé
     */
     ...
     *
     * <p>Cette méthode vérifie d'abord que la personne n'existe pas déjà
     * (basé sur la combinaison prénom + nom de famille) avant de l'ajouter.
     * Si une personne avec le même prénom et nom existe déjà, une exception est levée.
     *
     * <p>L'identité d'une personne est déterminée par la combinaison unique
     * de son prénom et de son nom de famille.
     *
     * @param person la personne à ajouter (doit contenir au minimum firstName et lastName)
     ...
     *
     * <p>Cette méthode recherche la personne par la combinaison prénom + nom de famille,
     * puis met à jour toutes ses informations (adresse, ville, code postal, téléphone, email).
     *
     * <p>L'identité de la personne (prénom et nom) ne peut pas être modifiée.
     * Pour changer l'identité, il faut supprimer la personne et en créer une nouvelle.
     *
     * <p>Si la personne n'existe pas dans le système, une exception est levée.
     *
     ...
     *
     * <p>Cette méthode recherche et supprime la personne identifiée par
     * la combinaison prénom + nom de famille.
     *
     * <p><strong>Attention :</strong> Cette opération ne supprime PAS automatiquement
     * le dossier médical associé à cette personne. Il est recommandé de supprimer
     * le dossier médical séparément via le service MedicalRecordService si nécessaire.
     *
     * <p>Si la personne n'existe pas dans le système, une exception est levée.
     *
